...
**Current: v1.2.0** (2026-06-24)

Bundles:
- **Run layer (root)** — `RUNBOOK.md` (one-shot request→delivery flow) + `REQUEST.md` (intake) + `OUTPUT.md` (handover) + `ROLES.md` (the review council — two-level: 9 Operating Roles that run the sweep + checklists under each; fast sweep = 3, full = 9) + `LOCAL-STABILITY.md` (local-ready checklist); **Auto Mode** wired into `AGENTS.md`/`00`.
...
Git tag for this release: **`v1.2.0`**.
